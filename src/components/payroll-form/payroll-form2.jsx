            ...
            <div className="content">
                <form className="form" action="#" onSubmit={save}>
                    ...
                    <div className="row">
                        ...
                        <input className ="input" type ="text" id = "name" name ="name" value={formValue.name} onChange={changeValue} placeholder = "Enter your name" />
                    </div>
                    ...
                    <div className = "profile-radio-button">
                        ...
                        <label>
                            <input type = "radio" checked={formValue.profileURL == '../../assets/profile-images/Ellipse -4.png'} name = "profileURL"
                    ...
                    <div className="row">
                        ...
                        <input className ="input" type ="number" id = "salary" name ="salary" value={formValue.salary} onChange={changeValue} placeholder = "Enter salary" />
                    </div>
